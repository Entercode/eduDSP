...
public class eduDSP extends Application {
    ...
    private void showMainStage(
		...
		try {
			...
			root = FXMLLoader.load(getClass().getResource("/eduDSP.fxml"));
			Scene scene = new Scene(root, 800, 600);
			mainStage.setTitle("FXML Welcome");
			mainStage.setScene(scene);
			mainStage.show();
		} catch (IOException ex) {
			Logger.getLogger(eduDSP.class.getName()).log(Level.SEVERE, null, ex);
		}
...
//        ));
// 
//        fina.itemsProperty().bind(friends);
// 
//        mainStage.setScene(new Scene(peopleView));
//        mainStage.show();l ListView<String> peopleView = new ListView<>();
